...
-- Change the key for rotating props
GM.PropRotKeyVar = CreateConVar("zs_proprotationkey", IN_WALK, FCVAR_REPLICATED, "From the IN_ enum values that can be found on the wiki")
